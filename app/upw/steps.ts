...
export default {
  ...
  '/other-adjustments': {
    pageTitle: 'Other adjustments',
    id: 'other-adjustments',
    controller: SaveAndContinue,
    template: `${__dirname}/templates/diversity-information/other-adjustments`,
    next: 'task-list#other-adjustments',
    fields: [
  ...
  '/training-and-employment-opportunities': {
    ...
    fields: [
      ...
      'training_and_employment_factors_preventing',
  ...
  '/availability': {
    ...
    fields: [
      ...
      'availability_intensive_working',
      'availability_intensive_working_no_details',
      'availability_availability_weekdays',
      'availability_availability_weekdays_no_details',
      'availability_want_to_considered_for_intensive_working',
